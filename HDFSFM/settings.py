"""
Django settings for HDFSFM project.
...
SECRET_KEY = ')ilvt)t5&e8n^u3q+*4qzcx9#s15$$8j%z0@2um50j%(1$7cv*'
...
WSGI_APPLICATION = 'HDFSFM.wsgi.application'
